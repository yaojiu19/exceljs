...
NumFmtXform.getDefaultFmtCode = function getDefaultFmtCode(numFmtId, language) {
  if (!defaultNumFormats[numFmtId]) return undefined;
  if (language && defaultNumFormats[numFmtId][language]) return defaultNumFormats[numFmtId][language];
